...
{
	class DaySlimeStaff : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Day Slime Staff");
			Tooltip.SetDefault("Summons a day type of slime for you!");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<BabyDaySlime>();
			item.buffType = ModContent.BuffType<DayTimeSlimeBuff>();
			item.melee = false;
			item.noMelee = true;
			item.summon = true;
		}
